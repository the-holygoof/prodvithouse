<?php
/**
 * Template Part: feature-cards
 * Description: feature-cards
 */
?>

<div class="benefits-wrapper my-auto md:pt-36 pb-32 md:pb-32 grid grid-cols-2 md:grid-cols-2 gap-3 md:gap-8 md:px-6 will-change-scroll">
    ...
    <!-- gwarancja poufnosci -->
        <div class="karta-outside card-feature my-auto" tabindex="0">                                        
            ...
            <div class="karta bg-card" style="background: linear-gradient(-40deg, var(--surface), var(--card));">
                ...
                <h6 class="z-50 text-white/90">Gwarancja poufności</h6>                                            
                <p class="text-white/50 text-sm sm:text-base mb-1">
    ...
    <!-- pobieranie krwi -->
        <div class="karta-outside card-feature my-auto content-stretch" tabindex="0">                                        
            ...
            <div class="karta bg-card" style="background: linear-gradient(-40deg, var(--surface), var(--card));">
                ...
                <h6 class="z-50 text-white/90">Pobieranie krwi w domu</h6>                                            
                <p class="text-white/50 text-sm sm:text-base mb-1">
    ...
    <!-- nadzór -->
        <div class="karta-outside card-feature my-auto items-stretch" tabindex="0">                                        
            ...
            <div class="karta bg-card" style="background: linear-gradient(-40deg, var(--surface), var(--card));">
                ...
                <h6 class="z-50 text-white/90">Nadzór medyczny 24/7</h6>                                            
                <p class="text-white/50 text-sm sm:text-base mb-1">
