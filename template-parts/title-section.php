...
<section class="md:-mt-8 sm:h-[581px] h-[381px] overflow-x-clip select-none">
    <div class="wrapper">
        <div id="title-slider" class="items-center w-full z-2">
            <?php if ($bg_url): ?>
            <div class="absolute overflow-hidden z-1 w-full h-[581px]">
            ...
            <div class="absolute lg:ml-10 px-4 md:px-0 z-12 h-[551px] w-[90%] md:w-1/2 flex items-center">
